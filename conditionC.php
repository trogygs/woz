 ...
 <body>
	...
	<?php
		...
		function loginForm (){
			...
			echo'
			<div id="loginform">
			<form action="conditionC.php" method="POST">
	...
	<div id="wrapper">
		...
		<div id="talker">
			...
			<script language="JavaScript" type="text/javascript">
				...
				AC_VHost_Embed(5314441,200,300,'',1,1, 2489221, 0,1,0,'37502337382bd94e5aef4d274638a504',9);
	...
	$(document).ready(function(){
		...
		setInterval (unlock, 10000); //check to unlock
