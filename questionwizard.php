 ...
 <body>
	...
	<div id="wrapper">
		...
		<form name="message" action="" method="POST">
			...
			<br><span>What is Breast Cancer</span><select name="feedbackA" id="feedbackA">
			...
			<br><span>Breast Cancer Spread</span><select name="feedbackB" id="feedbackB">
			...
			<br><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspBRCA Mutations</span><select name="feedbackC" id="feedbackC">
			...
			<br><span>&nbspBreast Cancer in Men</span><select name="feedbackD" id="feedbackD">
			...
			<br><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspGenetic Testing</span><select name="feedbackF" id="feedbackF">
			...
			<br><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspStages / Danger</span><select name="feedbackG" id="feedbackG">
			...
			<br><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEthnicity</span><select name="feedbackH" id="feedbackH">
			...
			<br><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspTreatment</span><select name="feedbackI" id="feedbackI">
			...
			<br><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspOther Cancers</span><select name="feedbackJ" id="feedbackJ">
			...
			<br><span>&nbsp&nbsp&nbsp&nbspRisk Factors / Odds</span><select name="feedbackK" id="feedbackK">
			...
			<br><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCancer and Age</span><select name="feedbackL" id="feedbackL">
			...
			<br><span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspInsurace / Privacy</span><select name="feedbackM" id="feedbackM">
	...
	$(document).ready(function(){
		...
		$("#submitmsg8").click(function(){	
			...
			$.post("tutorlog.php", {text: "Can you think of some other questions to ask?"});
			unlock();
			return false;
		...
		$("#submitmsg9").click(function(){	
			...
			$.post("tutorlog.php", {text: "Try to see if you can think of just a few more questions and then we'll move on."});
			unlock();
			return false;
		...
		$("#submitmsg10").click(function(){	
			...
			$.post("tutorlog.php", {text: "Can you think of a few more questions to ask? We'll be done soon."});
			unlock();
			return false;
		...
		$("#submitmsg12").click(function(){	
			...
			$.post("tutorlog.php", {text: "Can you think of just one more question to ask before we finish?"});
			unlock();
			return false;
		...
		$("#submitmsg13").click(function(){	
			...
			$.post("tutorlog.php", {text: "I'm sorry, I didn't get that question. What questions can you ask?"});
			unlock();
			return false;
		...
		$("#submitmsg15").click(function(){	
			...
			$.post("tutorlog.php", {text: "Are you still there? What questions can you ask?"});
			unlock();
			return false;
