 ...
 <body>
	...
	<?php
		...
		function loginForm (){
			...
			echo'
			<div id="loginform">
			<form action="condition2.php" method="POST">
	...
	<div id="wrapper">
		...
		<div id="talker">
			...
			<script language="JavaScript" type="text/javascript">
				...
				AC_VHost_Embed(5314441,200,300,'',1,1, 2447062, 0,1,0,'f1cbb212f90ba3765ea5ec975c124844',9);
	...
	$(document).ready(function(){
		...
		setInterval (unlock, 30000); //unlock every 30s in case stuck
